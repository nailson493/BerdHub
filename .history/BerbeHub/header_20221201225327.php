...
<nav class="border-gray-200 px-2 sm:px-4 py-2.5  ">
    ...
    <div class="flex md:order">
      ...
      <div class="hidden relative md:block mr-30">
        ...
        <input type="text" id="search-navbar" class="block p-2 pl-10 w-full text-gray-900 bg-gray-50 rounded-lg border border-gray-300 sm:text-sm focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-">
      </div>
